...
// CouchbaseClusterSpec defines the desired state of CouchbaseCluster
// +k8s:openapi-gen=true
type CouchbaseClusterSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "operator-sdk generate k8s" to regenerate code after modifying this file
	// Add custom validation using kubebuilder tags: https://book-v1.book.kubebuilder.io/beyond_basics/generating_crd.html
	DeployMe bool `json:deployme`
}

// CouchbaseClusterStatus defines the observed state of CouchbaseCluster
// +k8s:openapi-gen=true
...
// CouchbaseCluster is the Schema for the couchbaseclusters API
// +k8s:openapi-gen=true
...
// CouchbaseClusterList contains a list of CouchbaseCluster
